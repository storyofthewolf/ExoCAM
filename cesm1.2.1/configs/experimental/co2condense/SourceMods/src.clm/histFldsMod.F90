...
!-----------------------------------------------------------------------
    ...
    ! CO2 Surface Ice Properties
    
    call hist_addfld1d (fname='CO2DP',  units='kg/m**2',  &   ! mars
         avgflag='A', long_name='co2 frost mass', &           ! mars
         ptr_col=cps%co2dp, c2l_scale_type='urbanf')          ! mars

    call hist_addfld1d (fname='FRAC_CO2',  units='unitless',  &       ! mars
         avgflag='A', long_name='fraction of ground covered by CO2 frost', &  ! mars
         ptr_col=cps%frac_co2, c2l_scale_type='urbanf')                       ! mars

    call hist_addfld1d (fname='CO2_MASS_CHANGE',  units='kg/m**2',  &   ! mars
         avgflag='A', long_name='co2 mass change, timestep integrated', &           ! mars
         ptr_col=cps%co2_mass_change, c2l_scale_type='urbanf')          ! mars

    call hist_addfld1d (fname='CO2_TEMP_CHANGE',  units='K',  &
         avgflag='A', long_name='surface temperature change from CO2 cond/subl, timestep integrated', &
         ptr_col=ces%co2_temp_change, c2l_scale_type='urbans')
    ...
    call hist_addfld1d (fname='CO2ICE_LH',  units='W/m**2',  &                  ! mars
         avgflag='A', long_name='latent heat flux from CO2 condensation', &  ! mars
         ptr_pft=pef%co2ice_lh)                 ! mars
    ...
    call hist_addfld1d (fname='PBOT', units='Pa',  &
     ...
     call hist_addfld1d (fname='CO2SRF_SNOW', units='kg/m2',  &
         avgflag='A', long_name='co2 snow', &
         ptr_gcell=clm_a2l%forc_co2srf_snow)
