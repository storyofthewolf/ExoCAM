...
! !USES:
  ...
  use shr_const_mod, only: SHR_CONST_G,SHR_CONST_STEBOL,SHR_CONST_KARMAN,     &
                           ...
                           SHR_CONST_O2, SHR_CONST_CO2, SHR_CONST_TKAIR, & ! mars
                           SHR_CONST_CO2_ALVIS, SHR_CONST_CO2_ALNIR, SHR_CONST_MWWV, & ! mars
                           SHR_CONST_CO2_TI, SHR_CONST_DENSITYCO2FR, SHR_CONST_CPCO2ICE
...
!-----------------------------------------------------------------------
  ...
  ! constant thermal conductivities [W/m/K]
  !real(r8) :: tkair   = 0.023_r8     !thermal conductivity of air   [W/m/K]
  real(r8) :: tkair    = SHR_CONST_TKAIR  !thermal conductivity of air   [W/m/K] ! mars
  real(r8) :: tkco2ice = SHR_CONST_CO2_TI**2 / (SHR_CONST_DENSITYCO2FR * SHR_CONST_CPCO2ICE)
  ...
  ! mars, this is fixed constant needs changing
 ...
 ! albedo co2 ice ! mars
  real(r8) :: albco2(numrad) ! mars
  data (albco2(i),i=1,numrad) /SHR_CONST_CO2_ALVIS, SHR_CONST_CO2_ALNIR/  ! mars
