...
subroutine get_curr_calday_rotation(frac_day, frac_year, offset)
  ...
  real(r8) ,intent(out) :: frac_day        ! fractional time of day (0 to 1)    
  real(r8), intent(out) :: frac_year     ! fractional time of year (0 to 1)   
  ...
  integer ::&
   ...
   ! fractional day scaling, based on exo_ndays
   frac_day = day_earth/exo_ndays - FLOOR(day_earth/exo_ndays)

   ! fractional  year scaling, based on exo_porb
   frac_year = day_earth/exo_porb - FLOOR(day_earth/exo_porb)

   !write(*,*) "clm_time_manager:  day_earth, frac_year, frac_day ",day_earth, frac_year, frac_day
