...
subroutine diag_init()
  ...
  ! Declare the history fields for which this module contains outfld calls.
   ...
   call addfld ('CO2DP','kg/m2           ',1,    'A','Carbon dioxide frost mass',phys_decomp, fill_value = 1.e30_r8)  ! mars
   call addfld ('CO2MASSCHANGE','kg/m2   ',1,    'A','Carbon dioxide frost mass change',phys_decomp, fill_value = 1.e30_r8) ! mars
