...
!+Mods for Beres04
  ...
  real(r8), parameter :: effgw_beres=1.0_r8  ! beres source tendency efficiency
...
!===============================================================================
  ...
  subroutine gw_drag_readnl(nlfile)
    ...
    namelist /gw_drag_nl/ fcrit2, gw_drag_file
    !-----------------------------------------------------------------------------
...
! Set MGWD constants
    ...
    dback  = 0.05_r8          ! background diffusivity, only matters where k< nbot_molec
