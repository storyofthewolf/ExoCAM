...
! NOTES ::
  ...
  character(len=256), public, parameter :: exo_solar_file = '/home/deitrr/projects/def-czg/deitrr/ExoRT/data/solar/G2V_SUN_n68.nc'
  ...
  real(r8), public, parameter :: exo_co2bar  = 0.00028_r8                    ! CO2 inventory (bar)
  ...
  real(r8), public, parameter :: exo_o2bar   = 0.209_r8                        ! O2 inventory (bar)
