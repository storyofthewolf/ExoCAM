...
!
  ...
  integer, public ::index_l2x_Sl_srf_emiss ! surface emissivity ! mars
  integer, public ::index_l2x_Sl_snowh        ! snow height
  integer, public ::index_l2x_Sl_co2dp           ! co2 depth  ! mars
  integer, public ::index_l2x_Sl_co2_mass_change ! co2 mass change ! mars
  ...
  integer, public ::index_l2x_Fall_lat        ! latent          heat flux, water 
  integer, public ::index_l2x_Fall_lat_co2    ! latent          heat flux, co2
  ...
  integer, public ::index_x2l_Faxa_co2srf_snow    ! CO2 surface flux from snow [kg/m2/s]
  integer, public ::index_x2l_Faxa_co2srf_cond    ! CO2 surface flux from condensation [kg/m3/s]
...
!-----------------------------------------------------------------------
    ...
    index_l2x_Sl_co2dp                = mct_avect_indexra(l2x,'Sl_co2dp')  ! mars
    index_l2x_Sl_co2_mass_change      = mct_avect_indexra(l2x,'Sl_co2_mass_change') ! mars
    index_l2x_Sl_srf_emiss             = mct_avect_indexra(l2x,'Sl_srf_emiss') ! mars
    ...
    index_l2x_Fall_lat_co2  = mct_avect_indexra(l2x,'Fall_lat_co2')  ! Mars
    ...
    ! ETW MARS CO2 surface flux from atmosphere model calculations
    index_x2l_Faxa_co2srf_snow  = mct_avect_indexra(x2l,'Faxa_co2srf_snow')
    index_x2l_Faxa_co2srf_cond  = mct_avect_indexra(x2l,'Faxa_co2srf_cond')
