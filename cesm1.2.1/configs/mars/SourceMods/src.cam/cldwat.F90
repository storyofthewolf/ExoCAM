...
!-----------------------------------------------------------------------
   ...
   use physconst,     only: latvap, latice, cpair, rair
...
! drop size enough to enhance the auto-conversion process (mm/day)
   critpr = 0.5_r8
   convfw = 1.94_r8*2.13_r8*sqrt(rhow*1000._r8*shr_const_g*2.7e-4_r8)

! liquid microphysics
!  cracw = 6_r8                 ! beheng
   cracw = .884_r8*sqrt(shr_const_g/(rhow*1000._r8*2.7e-4_r8)) ! tripoli and cotton
