module physpkg
  ...
  use exoplanet_mod,   only: do_exo_rt, do_exo_gw, do_exo_condense_co2
...
subroutine phys_register
    ...
    use exo_condense_mod,   only: exo_condense_register
...
subroutine phys_init( phys_state, phys_tend, pbuf2d, cam_out )
    ...
    use exo_condense_mod,   only: exo_condense_init
...
subroutine tphysbc (ztodt,               &
    ...
    use exo_condense_mod, only: exo_condense_tend, exo_condense_diag_calc
    ...
    if (do_exo_condense_co2) then 
       call t_startf ('exo_condense_tend')
       call exo_condense_tend( state, pbuf, cam_in, cam_out,  ptend)
