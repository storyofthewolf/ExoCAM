...
! !PUBLIC DATA MEMBERS:
  ...
  logical :: substep_uv = .false.        ! Should u and v tendencies by applied per dynamics substep?
  logical :: substep_t = .false.         ! Should temperature tendency by applied per remap substep?
...
! Local variables
   ...
   call mpibcast (substep_uv,1,mpilog,0,mpicom)
   call mpibcast (substep_t,1,mpilog,0,mpicom)
