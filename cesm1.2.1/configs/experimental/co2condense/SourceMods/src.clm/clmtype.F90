...
type, public :: pft_eflux_type
   ...
   real(r8), pointer :: co2ice_lh(:)      ! co2 latent heat flux (W/m**2)     ! mars
...
type, public :: column_pstate_type
   ...
   real(r8), pointer :: thermal_conduct(:)    !soil thermal conductivity from thermal inertia input, 2D ! mars
   real(r8), pointer :: thermal_inertia(:)    !soil thermal inertia from input, 2D ! mars
   ...
   real(r8), pointer :: srf_emiss(:)          ! Surface emissivity to be passed to atmosphere model      ! mars
   real(r8), pointer :: co2dp(:)              !co2 snow column mass (kg/m**2)      ! mars
   real(r8), pointer :: co2_mass_change(:)    !co2 column mass change          ! mars
   real(r8), pointer :: frac_co2(:)           !fraction of ground covered by CO2 frost ! mars
   ...
   real(r8), pointer :: z0m_ini(:)            !roughness length over ground, momentum [m] !mars
...
type, public :: column_estate_type
   ...
   real(r8), pointer :: co2_temp_change(:)    !co2 column temp change          ! mars
