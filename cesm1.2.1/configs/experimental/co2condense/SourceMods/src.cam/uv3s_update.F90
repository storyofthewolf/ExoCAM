...
!!   subroutine uv3s_update(grid, dua, u3s, dva, v3s, dt5) !! C.Bardeen
     subroutine uv3s_update(grid, dua, u3s, fu3s, dva, v3s, fv3s, dt5)  !! C.Bardeen
...
! !INPUT/OUTPUT PARAMETERS:
      ...
      real(r8), intent(inout) :: fu3s(grid%ifirstxy:grid%ilastxy,grid%jfirstxy:grid%jlastxy, &
                                     grid%km)          ! U-Wind tendency on D Grid
      real(r8), intent(inout) :: fv3s(grid%ifirstxy:grid%ilastxy,grid%jfirstxy:grid%jlastxy, &
                                     grid%km)          ! V-Wind tendency on D Grid
...
!!   real(r8) :: fu3s    (grid%ifirstxy:grid%ilastxy,grid%jfirstxy:grid%jlastxy,grid%km)  !! C.Bardeen
!!   real(r8) :: fv3s    (grid%ifirstxy:grid%ilastxy,grid%jfirstxy:grid%jlastxy,grid%km)  !! C.Bardeen
