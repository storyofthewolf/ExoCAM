...
!------------------------------------------------------------------------
    ...
    allocate(cps%thermal_conduct(beg:end))  !* cannot be averaged up ! mars
    allocate(cps%thermal_inertia(beg:end))  !* cannot be averaged up ! mars
...
!   allocate(cps%xirrig(beg:end))
    ...
    cps%thermal_conduct(beg:end) = ival  ! mars
    cps%thermal_inertia(beg:end) = ival ! mars
...
!------------------------------------------------------------------------
    ...
    allocate(ces%co2_temp_change(beg:end))
    ...
    ces%co2_temp_change(beg:end) = ival
