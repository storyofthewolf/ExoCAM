...
MODULE shr_const_mod
   ...
   real(R8),parameter :: SHR_CONST_MSUN   = 1.989e30_R8         ! Mass of Sun ~kg
   real(R8),parameter :: SHR_CONST_LSUN   = 3.828e26_R8         ! Luminosity of Sun ~W
   real(R8),parameter :: SHR_CONST_AU    = 1.49597870700e11_R8 ! an Astronomical Unit
   real(R8),parameter :: SHR_CONST_MEARTH   = 5.972e24_R8         ! Mass of Earth ~kg
   real(R8),parameter :: SHR_CONST_GRAVCON  = 6.67408e-11 !m^3 kg^-1 s^-2  
