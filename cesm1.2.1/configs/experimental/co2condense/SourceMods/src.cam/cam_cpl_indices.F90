module cam_cpl_indices
  ...
  integer :: index_a2x_Faxa_co2srf_snow  ! CO2 snow fall flux from atmosphere to surface  ! [kg/m2/s] mars
  integer :: index_a2x_Faxa_co2srf_cond  ! CO2 surface condensation flux from atmosphere to surface   ! [kg/m3/s] mars
  ...
  integer :: index_x2a_Sl_srf_emiss              ! surface emissivity  ! mars
  integer :: index_x2a_Sl_co2dp                  ! co2 frost mass  ! mars
  integer :: index_x2a_Sl_co2_mass_change        ! co2 frost mass change  ! mars
  integer :: index_x2a_Faxx_lat_co2              ! latent heat flux from CO2 
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_x2a_Sl_srf_emiss            = mct_avect_indexra(x2a,'Sl_srf_emiss') ! mars
    index_x2a_Sl_co2dp                = mct_avect_indexra(x2a,'Sl_co2dp') ! mars
    index_x2a_Sl_co2_mass_change      = mct_avect_indexra(x2a,'Sl_co2_mass_change') ! mars
    index_x2a_Faxx_lat_co2      = mct_avect_indexra(x2a,'Faxx_lat_co2')    
    ...
    index_a2x_Faxa_co2srf_snow    = mct_avect_indexra(a2x,'Faxa_co2srf_snow') ! Mars
    index_a2x_Faxa_co2srf_cond    = mct_avect_indexra(a2x,'Faxa_co2srf_cond') ! Mars
