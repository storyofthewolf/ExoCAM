...
!-------------------------------------------------------------------------------
     ...
     ! co2 ice surface flux (atm to surface modules)
!     call seq_flds_add(a2x_fluxes,"Faxa_co2srf_flux")
!     call seq_flds_add(x2i_fluxes,"Faxa_co2srf_flux")
!     call seq_flds_add(x2l_fluxes,"Faxa_co2srf_flux")
!     longname = 'CO2 ice surface flux'
!     stdname  = 'surface_downward_CO2_ice_flux_due_to_condensation_and_snowfall' 
!     units    = 'Kg m-2 s-1'
!     attname  = 'Faxa_co2srf_flux'
!     call metadata_set(attname, longname, stdname, units)

     ! co2 snow to surface flux (atm to surface modules)
     call seq_flds_add(a2x_fluxes,"Faxa_co2srf_snow")
     call seq_flds_add(x2i_fluxes,"Faxa_co2srf_snow")
     call seq_flds_add(x2l_fluxes,"Faxa_co2srf_snow")
     longname = 'CO2 snow to surface flux'
     stdname  = 'surface_downward_CO2_flux_due_to_snowfall' 
     units    = 'Kg m-2 s-1'
     attname  = 'Faxa_co2srf_snow'
     call metadata_set(attname, longname, stdname, units)

     ! co2 ice condensation to surface flux (atm to surface modules)
     call seq_flds_add(a2x_fluxes,"Faxa_co2srf_cond")
     call seq_flds_add(x2i_fluxes,"Faxa_co2srf_cond")
     call seq_flds_add(x2l_fluxes,"Faxa_co2srf_cond")
     longname = 'CO2 ice condensation to surface flux'
     stdname  = 'surface_downward_CO2_ice_flux_due_to_condensation' 
     units    = 'Kg m-3 s-1'
     attname  = 'Faxa_co2srf_cond'
     call metadata_set(attname, longname, stdname, units)
     ...
     ! Surface emissivity (land/atm only)  ! mars
     call seq_flds_add(l2x_states,"Sl_srf_emiss")    
     call seq_flds_add(x2a_states,"Sl_srf_emiss")    
     longname = 'surface emissivity'
     stdname  = 'surface_emissivity'
     units    = 'unitless'
     attname  = 'Sl_srf_emiss'
     call metadata_set(attname, longname, stdname, units)
     ...
     ! Surface co2 frost amount (land/atm only)  ! mars
     call seq_flds_add(l2x_states,"Sl_co2dp")    
     call seq_flds_add(x2a_states,"Sl_co2dp")    
     longname = 'CO2 frost mass'
     stdname  = 'co2_frost_mass'
     units    = 'kg m-2'
     attname  = 'Sl_co2dp'
     call metadata_set(attname, longname, stdname, units)

     ! Surface co2 frost amount (land/atm only)  ! mars
     call seq_flds_add(l2x_states,"Sl_co2_mass_change")    
     call seq_flds_add(x2a_states,"Sl_co2_mass_change")    
     longname = 'CO2 mass change'
     stdname  = 'co2_mass_change'
     units    = 'kg m-2'
     attname  = 'Sl_co2_mass_change'
     call metadata_set(attname, longname, stdname, units)
    ...
    ! Surface CO2 latent heat flux                                                                                                                         
     call seq_flds_add(l2x_fluxes,"Fall_lat_co2")
     call seq_flds_add(xao_fluxes,"Faox_lat_co2")
     call seq_flds_add(i2x_fluxes,"Faii_lat_co2")
     call seq_flds_add(x2a_fluxes,"Faxx_lat_co2")
     call seq_flds_add(x2o_fluxes,"Foxx_lat_co2")
     longname = 'Surface CO2 latent heat flux'
     stdname  = 'surface_upward_co2_latent_heat_flux'
     units    = 'W m-2'
     attname  = 'Fall_lat_co2'
     call metadata_set(attname, longname, stdname, units)
     attname  = 'Faox_lat_co2'
     call metadata_set(attname, longname, stdname, units)
     attname  = 'Faii_lat_co2'
     call metadata_set(attname, longname, stdname, units)
     attname  = 'Faxx_lat_co2'
     call metadata_set(attname, longname, stdname, units)
     attname  = 'Foxx_lat_co2'
     call metadata_set(attname, longname, stdname, units)
