...
! Local workspace
    ...
    ! mars
    real(r8) :: delptemp                ! temporary delp var ! mars
    logical  :: do_co2_exloop           ! logical if condensated co2 > bottom atm layer  !mars
    integer  :: nlay = 1.               ! total number of condensed layers  !mars
